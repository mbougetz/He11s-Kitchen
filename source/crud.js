...
function init() {
  ...
  if(document.getElementById("addRecipeBtn"))document.getElementById("addRecipeBtn").addEventListener("click", function (){
    redirectToCRUD();
  });

  //Super janky way of detecting the page source has been changed to crud.html
  if(!document.getElementById("addRecipeBtn") && document.getElementById("add")) crudPageInit();
...
function addRecipe() {
  ...
  let newRecipe = {
    ...
    image: "https://images.freeimages.com/images/large-previews/7f5/plate-1329634.jpg",
